...
export { BREAKING_SPACES, BREAKING_SPACES_SET, NEWLINES, NEWLINES_SET, NEWLINE_MATCH_REGEX, NEWLINE_SPLIT_REGEX, collapseNewlines, collapseSpaces, getCharacterGroups, isBreakingSpace, isNewline, tokenize, trimRight } from './scene/text/canvas/utils/textTokenization.mjs';
